...
(function (global, factory) {
  ...
  ElementPlus = ElementPlus && Object.prototype.hasOwnProperty.call(ElementPlus, 'default') ? ElementPlus['default'] : ElementPlus;
  ...
  var Checkbox = vue.defineComponent({
    ...
    setup: function setup(props, _) {
      ...
      var update = function update() {
        trueValue.value = value.value ? options.value.filter(function (opt) {
      ...
      return {
        ...
        onInput: function onInput(n) {
          _.emit('update:modelValue', options.value.filter(function (opt) {
  ...
  var Frame = vue.defineComponent({
    ...
    methods: {
      ...
      makeInput: function makeInput() {
        ...
        return vue.createVNode(vue.resolveComponent("ElInput"), vue.mergeProps({
          ...
          suffix: function suffix() {
            return _this.fileList.length ? vue.createVNode("i", {
      ...
      makeFiles: function makeFiles() {
        ...
        return this.makeGroup(this.fileList.map(function (src, index) {
          return _this4.makeItem(index, [vue.createVNode("i", {
      ...
      handleClick: function handleClick(src) {
        ...
        return (this.onHandle || function (src) {
          ...
          if (this.helper === true) {
            iframe['form_create_helper'] = {
              ...
              set: function set(field, value) {
                ...
                !_this8.disabled && _this8.$emit('update:modelValue', value);
              },
      ...
      makeFooter: function makeFooter() {
        ...
        return vue.createVNode("div", null, [closeBtn ? vue.createVNode(vue.resolveComponent("ElButton"), {
          "onClick": function onClick() {
            return _this9.onCancel() !== false && (_this9.frameVisible = false);
          }
          ...
          "type": "primary",
          "onClick": function onClick() {
            return _this9.onOk() !== false && _this9.closeModel();
          }
    ...
    render: function render() {
      ...
      return vue.createVNode("div", {
        ...
        "default": function _default() {
          return [_this10.frameVisible || !_this10.reload ? vue.createVNode("iframe", {
            "ref": "frame",
            "src": src,
            "frameBorder": "0",
            "style": {
  ...
  var Radio = vue.defineComponent({
    ...
    setup: function setup(props, _) {
      ...
      var update = function update() {
        trueValue.value = options.value.filter(function (opt) {
  ...
  var Upload = vue.defineComponent({
    ...
    methods: {
      ...
      handleClick: function handleClick(file) {
        ...
        window.vm2 = this;
        (this.onHandle || function (file) {
          _this.previewImage = file.url;
          _this.previewVisible = true;
        })(file);
      },
      makeItem: function makeItem(file, index) {
        return this.uploadType === 'image' ? vue.createVNode("img", {
          "src": file.url,
      ...
      makeProgress: function makeProgress(file, index) {
        return vue.createVNode(vue.resolveComponent("ElProgress"), vue.mergeProps({
      ...
      makeFiles: function makeFiles() {
        ...
        return this.uploadList.map(function (file, index) {
          return vue.createVNode("div", {
            ...
            "class": 'fc-files'
          }, [file.percentage !== undefined && file.status !== 'success' ? _this4.makeProgress(file, index) : [_this4.makeItem(file, index), _this4.makeIcons(file, index)]]);
        });
      },
      makeUpload: function makeUpload() {
        ...
        return vue.createVNode(vue.resolveComponent("ElUpload"), vue.mergeProps(this.$attrs, {
          "showFileList": false,
          ...
          "default": function _default() {
            return [isShow ? ((_this$$slots$default = (_this$$slots = _this5.$slots)["default"]) === null || _this$$slots$default === void 0 ? void 0 : _this$$slots$default.call(_this$$slots)) || vue.createVNode("div", {
              "class": 'fc-upload-btn'
            }, [vue.createVNode("i", {
    ...
    render: function render() {
      ...
      return vue.createVNode("div", {
        "class": '_fc-upload'
      }, [[this.$attrs.showFileList ? [] : this.makeFiles(), this.makeUpload()], vue.createVNode(vue.resolveComponent("ElDialog"), {
        "appendToBody": true,
        "modal": this.previewMask,
            ...
            return [vue.createVNode(vue.resolveComponent("ElCol"), {
              ...
              "default": function _default() {
                return [vue.createVNode(vue.resolveComponent("ElFormItem"), null, {
                  "default": function _default() {
                    return [vue.createVNode(vue.resolveComponent("FormCreate"), {
                      "key": key,
              ...
              "pull": 1,
              "push": 1
            }, _isSlot$1(_slot = _this9.makeIcon(keys.length, index, key)) ? _slot : {
              "default": function _default() {
                return [_slot];
              }
            }) : null];
  ...
  var keyAttrs = ['type', 'slot', 'emitPrefix', 'value', 'name', 'native', 'hidden', 'display', 'inject', 'options', 'emit', 'link', 'prefix', 'suffix', 'update', 'sync', 'optionsTo', 'key'];
    ...
    extend(Render.prototype, {
        ...
        if (!this.cache[ctx.id] || this.cache[ctx.id].slot !== rule.slot) {
          ...
          vn = function vn() {
            return _this3.item(ctx, function () {
              var _vn = ctx.parser.render(_this3.renderChildren(ctx), ctx);
      ...
      ctxProp: function ctxProp(ctx, custom) {
        ...
        if (!custom && ctx.input) {
          ...
          props.push({
            ...
            props: _defineProperty({}, field, this.$handle.getFormData(ctx))
          });
        }
      ...
      renderChildren: function renderChildren(ctx) {
        ...
        children.map(function (child) {
          ...
          if (flag && !_this7.$handle.isRepeatRule(child.__origin__ || child) && child.type) {
            flag = false;
  ...
  function useInput(Handler) {
    extend(Handler.prototype, {
      ...
      syncForm: function syncForm() {
        ...
        Object.keys(this.formData).reduce(function (initial, field) {
          ...
          initial[field] = vue.customRef(function (track, trigger) {
            return {
              get: function get() {
                track();
      ...
      watchCtx: function watchCtx(ctx) {
        ...
        all.filter(function (k) {
          ...
          ctx.watch.push(vue.watch(flag ? function () {
            return _toConsumableArray(ref.value || []);
          } : ref, function (_, o) {
            var n = ref.value;
            ...
            if (key === 'link') {
              ...
              _this.deferSyncValue(function () {
                o && o.forEach(function (child) {
                  if ((n || []).indexOf(child) === -1 && child && !is.String(child) && child.__fc__ && !_this.ctxs[child.__fc__.id]) {
                    _this.rmCtx(child.__fc__);
                  }
                });
                is.trueArray(n) && _this.loadChildren(n, ctx);
              });
            }
        ...
        if (ctx.input) {
          ...
          ctx.watch.push(vue.watch(val, function () {
  ...
  function tidyDirectives(directives) {
    return Object.keys(directives).map(function (n) {
      ...
      return [vue.resolveDirective(n), directive.arg, directive.value, directive.modifiers];
    });
  }
