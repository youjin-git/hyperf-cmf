<template>
	<el-drawer title="修改生成配置1233" v-model="drawer" size="80%">
		<el-form
			ref="form"
			:model="form"
			:rules="rules"
			...
			<el-tabs v-model="activeName">
				<el-tab-pane label="配置信息" name="config">
					...
					<el-row :gutter="24">
						<el-col :xs="24" :md="12" :xl="12">
							<el-form-item
								class="ma-inline-form-item"
								prop="module_name"
							>
								<template #label>
									所属模块
									<el-tooltip
										content="所属模块请对应表模块前缀，否则数据迁移文件不会被执行"
									>
						...
						<el-col :xs="24" :md="12" :xl="12">
							<el-form-item prop="package_name">
								<template #label>
									包名
									<el-tooltip
										content="控制器文件所在目录名，比如：permission"
									>
										<i class="el-icon-question"></i>
									</el-tooltip>
								</template>
							...
							<el-form-item prop="generate_type">
								...
								<el-radio-group v-model="form.generate_type">
									<el-radio-button label="0"
										>压缩包下载</el-radio-button
									>
									<el-radio-button label="1"
										>生成到模块</el-radio-button
									>
								</el-radio-group>
							</el-form-item>
						</el-col>
