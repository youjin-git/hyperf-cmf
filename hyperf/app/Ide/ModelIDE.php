...
class ModelIDE
{
     ...
     * @return Builder|static
     */
    public function hasMorph($relation, $types, $operator = '>=', $count = 1, $boolean = 'and', $callback = null)
    {
     ...
     * @return Builder|static
     */
    public function doesntHaveMorph($relation, $types, $boolean = 'and', $callback = null)
    {
     ...
     * @return Builder|static
     */
    public function whereHasMorph($relation, $types, $callback = null, $operator = '>=', $count = 1)
    {
     ...
     * @return Builder|static
     */
    public function orWhereHasMorph($relation, $types, $callback = null, $operator = '>=', $count = 1)
    {
     ...
     * @return Builder|static
     */
    public function whereDoesntHaveMorph($relation, $types, $callback = null)
    {
     ...
     * @return Builder|static
     */
    public function orWhereDoesntHaveMorph($relation, $types, $callback = null)
    {
     ...
     * @return Builder|static
     */
    public function mergeConstraintsFrom($from)
    {
     ...
     * @return \Hyperf\Database\Query\Builder
     */
    public function havingBetween($column, $values, $boolean = 'and', $not = false)
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function setBindings($bindings, $type = 'where')
    {
